#!/bin/bash
#SBATCH --job-name=trim_nov21_Truseq
#SBATCH --qos=long-mem
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=12
#SBATCH --mem=100GB
#SBATCH --time=5-00:00:00
#SBATCH --output=trim_nov21_Truseq_09.11.25.log
...
then
	...
	do
		...
		trimmomatic PE -threads 8 ${path}/${read1} ${path}/${read2} \
			       ...
			       ILLUMINACLIP:/home/gaferguz/Extras/adaptors/TruSeq3-PE.fa:2:30:10:8:True  SLIDINGWINDOW:4:20 MINLEN:50 LEADING:28
