...
# Comprobacion de que el numero filtrado coincide con el de los ids utilizados
wc -l *gr.txt
...
# Analisis del ensamblaje con metaquast
...
# Usamos el script tr2cds.pl y usando un umbral de 65 aa de longitud
/arthropods.eugenes.org/EvidentialGene/evigene/scripts/prot/tr2aacds4.pl -MINAA 65 -strandedrna yes -cdnaseq over1_sg_Merged_tx.fasta -species=Bge
